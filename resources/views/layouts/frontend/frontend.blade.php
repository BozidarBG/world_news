...
<div class="main-content-wrapper section-padding-100">
    <div class="container">
        <div class="row justify-content-center">
            @if(!Auth::check())
            <!-- hidden login form-->
            <div class="col-md-8 hidden-form mb-30" id="login-form">
            ...
            <div class="col-md-8 hidden-form mb-30" id="register-form">
                <div class="card square">
...
<!-- jQuery, popper and bootstrap(Necessary for All JavaScript Plugins) -->
